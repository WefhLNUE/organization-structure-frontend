...
export default function UpdateDepartmentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:5000/organization-structure/departments/${formData.id}`, {
        method: 'PUT',
        headers: {
  ...
  return (
    <div className="p-8 max-w-2xl">
      <h1 className="text-2xl font-semibold mb-6">Update Department</h1>
